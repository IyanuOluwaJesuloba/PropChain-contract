...
mod propchain_contracts {
    ...
    pub enum Error {
        ...
        ValueOutOfBounds,
        /// Batch operation exceeds maximum allowed size
    ...
    impl PropertyRegistry {
        ...
        pub fn batch_register_properties(
            ...
            self.ensure_not_paused()?;
            Self::ensure_batch_size_ok(&properties)?;
        ...
        pub fn batch_transfer_properties(
            ...
            self.ensure_not_paused()?;
            Self::ensure_batch_size_ok(&property_ids)?;
            Self::ensure_not_zero_address(to)?;
            let caller = self.env().caller();
            Self::ensure_not_self(caller, to)?;
        ...
        pub fn batch_update_metadata(
            ...
            self.ensure_not_paused()?;
            Self::ensure_batch_size_ok(&updates)?;
            let caller = self.env().caller();
        ...
        pub fn batch_transfer_properties_to_multiple(
            ...
            self.ensure_not_paused()?;
            Self::ensure_batch_size_ok(&transfers)?;
            let caller = self.env().caller();
    ...
    impl PropertyRegistry {
        ...
        /// Validates batch size is within limits and non-empty.
        fn ensure_batch_size_ok<T>(items: &[T]) -> Result<(), Error> {
